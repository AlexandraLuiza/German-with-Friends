    ...
    <>
      <div>
        ...
        <p className='introparag'>
          When the date is written in German, the day and the month ar written
          as ordinal numbers. But the month cna also be written out as a word, a
        ...
        <p className='introparag'>
          ...
          article.
          <img className='calendar' src='calendar.jpg' alt='calendar'></img>
        </p>
        ...
        <p className='introparag'>
          <em>
            Example: Es war ein fünft<u>er</u> Oktober. (indefinite article →
            er)
          </em>
        </p>
        <p className='introparag'>
